...
/**
 * @brief Vector of 2 floats, used primarily for representing texture coordinates
 */
class vec2 {
    ...
    vec2(float f1, float f2) : f1(f1), f2(f2) {}
...
/**
 * @brief Vector of 3 floats, used for a variety of purposes such 
 * as points, vectors, and colors.
 */
class vec3 {
